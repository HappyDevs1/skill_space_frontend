        ...
        <div className="flex flex-col gap-4 mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-8">
            ...
            <div className="flex gap-5 items-center">
              <input className="border border-2 rounded h-9 w-full md:w-40 pl-4" placeholder="Search for articles..." />
        ...
        <div className="container mx-auto p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg shadow-lg">
              <img
                src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af1144/649cf7a8738eb73adf31d215_career-ui-ux-designer-featured-image-jobboardly-x-webflow-template-p-800.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            <div className="flex flex-col items-center bg-blue-600 rounded-lg shadow-lg my-20 py-14">
              ...
              <p className="text-white text-center">
                This is a test message for the newsletter. I will come back to it to finalize this <br />
                text. This is just a test message. I will come back to it to edit it later on, sharp.
              </p>
              <div className="flex gap-5 mt-7 justify-center">
                <input className="w-full sm:w-80 h-9 px-5 rounded" placeholder="Enter your email address..." />
          ...
          <div className="container mx-auto p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
              <div className="flex flex-col items-center shadow-lg rounded-xl">
                <img
                  src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af1144/649cf761ba75cbd927cb4823_technical-interview-thumbnail-image-jobboardly-x-webflow-template.png"
              ...
              <div className="flex flex-col items-center shadow-lg rounded-xl">
                <img
                  src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af1144/649cf7892b81d5ad8223aa61_digital-marketing-trends-thumbnail-image-jobboardly-x-webflow-template.png"
                  className="rounded-t-xl"
                />
                <div className="p-6">
                  <div className="flex items-center text-xs my-7 font-bold">
              ...
              <div className="flex flex-col items-center shadow-lg rounded-xl">
                <img
                  src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af1144/649cf7ac1c92b85a2e4387ed_career-ui-ux-designer-thumbnail-image-jobboardly-x-webflow-template.png"
                  className="rounded-t-xl"
                />
                <div className="p-6">
                  <div className="flex items-center text-xs my-7 font-bold">
              ...
              <div className="flex flex-col items-center shadow-lg rounded-xl">
                <img
                  src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af1144/649cf7e4ea437f1f11997f45_8-innovative-design-ideas-thumbnail-image-jobboardly-x-webflow-template.png"
                  className="rounded-t-xl"
                />
                <div className="p-6">
                  <div className="flex items-center text-xs my-7 font-bold">
