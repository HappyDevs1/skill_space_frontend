...
function LoginCompany({ isAuthenticated, setIsAuthenticated }: NavBarProps): JSX.Element {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const redirectUrl = await loginCompany(formData);
      ...
      console.error("Error loggin in company.");
    }
  }
        ...
        <div className="grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FaRegUserCircle className="text-5xl text-blue-500"/>
            ...
            <div className="flex flex-col gap-5">
              ...
              <button className="bg-blue-500 text-white font-bold rounded py-1"
              type="submit"
