        ...
        loading ? (
          ...
          company ? (
            ...
            <div className="flex flex-col justify-center mx-[19%] my-[5%] py-[%] border-2 rounded-xl">
              ...
              <div className="flex justify-center items-center w-[11%] h-20 rounded-xl">
                <div>
                  <img src={company.profilePicture} className="rounded-xl"/>
                </div>
              </div>
              <div className="flex justify-between items-center">
              <p className="font-bold text-3xl my-[3%] mx">{company.name}</p>
              <div>
