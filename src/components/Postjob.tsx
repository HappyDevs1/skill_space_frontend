    ...
    <div>
      <div className="flex mt-24 justify-evenly mb-20">
        <div className="bg-blue-600 px-16 py-10 rounded">
          ...
          <button className="bg-white rounded px-2 py-1" onClick={handlePostJob}>Post a featured job</button>
        </div>
        <div className="bg-gray-100 px-16 py-10 rounded">
          ...
          <button className="bg-blue-500 text-white rounded px-2 py-1" onClick={handlePostJob}>Post a free job</button>
        </div>
      </div>
    </div>
  )
